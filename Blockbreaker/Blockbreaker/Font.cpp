...
void Font_init() {
	...
	GenJyuuGothicLHeavy_Edge25 = CreateFontToHandle(_T("源桑ゴシックL Heavy"), 25, -1, DX_FONTTYPE_EDGE, -1, 1, 0, -1);
	GenJyuuGothicLHeavy_Edge30 = CreateFontToHandle(_T("源桑ゴシックL Heavy"), 30, -1, DX_FONTTYPE_EDGE, -1, 1, 0, -1);
	GenJyuuGothicLHeavy_Edge35 = CreateFontToHandle(_T("源桑ゴシックL Heavy"), 35, -1, DX_FONTTYPE_EDGE, -1, 1, 0, -1);
	GenJyuuGothicLHeavy_Edge40 = CreateFontToHandle(_T("源桑ゴシックL Heavy"), 40, -1, DX_FONTTYPE_EDGE, -1, 1, 0, -1);
	GenJyuuGothicLHeavy_Edge50 = CreateFontToHandle(_T("源桑ゴシックL Heavy"), 50, -1, DX_FONTTYPE_EDGE, -1, 1, 0, -1);
	GenJyuuGothicLHeavy_Edge60 = CreateFontToHandle(_T("源桑ゴシックL Heavy"), 60, -1, DX_FONTTYPE_EDGE, -1, 1, 0, -1);
	GenJyuuGothicLHeavy_Edge70 = CreateFontToHandle(_T("源桑ゴシックL Heavy"), 70, -1, DX_FONTTYPE_EDGE, -1, 1, 0, -1);
	GenJyuuGothicLHeavy_Edge80 = CreateFontToHandle(_T("源桑ゴシックL Heavy"), 80, -1, DX_FONTTYPE_EDGE, -1, 1, 0, -1);
